	    ...
	    <table cellpadding="5">
	        <tr>
	            ...
	            <td>
					...
					<span style='margin-left:10px;' id="itemCatName"></span>
					<input type="hidden" name="itemCatName" id="itemCatNames"/>
...
<script type="text/javascript">
	...
	$(function(){
		//实例化编辑器
		itemEditEditor = KindEditorUtil.createEditor("#itemEditForm [name=itemDesc]");

		//回调函数
		setTimeout(function () {
			//第一种方式：通过input标签获取到form表单回显的值，再通过回调函数赋值给span
			var CatName = $("#itemCatNames").val();
			//动态给span标签赋值
			$("#itemCatName").html(CatName)
			console.log("CatName: "+CatName)
			// //第二种方式：直接获取到form表单的所有数据，并通过遍历的方式判断name属性，最后将得到的value值赋值给span标签
			// var aa = $('form[id="itemEditForm"]').serializeArray();
