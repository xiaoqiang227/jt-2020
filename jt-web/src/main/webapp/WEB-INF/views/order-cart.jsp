...
<!--********滿贈套装開始*********-->
		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart" varStatus="status">
				<c:if test="${cart != null}"> <c:set var="itemNum" value="${status.index +1}" /> </c:if>
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
...
<!--**********商品清单内容列表结束************-->
										...
										<div class="order-summary">
											...
											<div class="statistic fr">
                                                <div class="list"><span><em id="span-skuNum"><c:out value="${itemNum}"/></em> 件商品，总商品金额：</span><em class="price" id="warePriceId" v="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/100 }"/>">￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/100 }"/></em></div>
